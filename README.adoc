...
By default the destination image name is used without the registry and tag parts.

|`component-id`
| String
| No
| The ID of the component to which the artifact belongs.
If not provided, the artifact will be registered with the component id of the current workflow run.
|===
